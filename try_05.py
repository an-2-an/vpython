...
longHand = curve(pos=[vector(0, 0, 0), vector(0, 0.9, 0)], color=color.blue, radius=0.05)
shortHand = curve(pos=[vector(0, 0, 0), vector(0, 0.6, 0)], color=color.red, radius=0.08)
